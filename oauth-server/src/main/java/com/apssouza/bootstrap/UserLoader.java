...
public class UserLoader implements ApplicationListener<ContextRefreshedEvent>  {
    ...
    public void onApplicationEvent(ContextRefreshedEvent e) {
        Account user1 = new Account( "apssouza22@gmail.com", "1234");
        Account user2 = new Account( "gaelle@gmail.com", "123");
        Account user3 = new Account( "marciapalito@hotmail.com", "222");
